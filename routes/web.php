...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/api/chat', [ChatApiController::class, 'stream'])->name('api.chat.stream');
    Route::get('/api/chat/history/{id}', [ChatApiController::class, 'history'])->name('api.chat.history');
